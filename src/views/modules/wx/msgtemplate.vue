    ...
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button v-if="isAuth('wx:msgtemplate:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
            ...
            <el-table-column prop="templateId" header-align="center" align="center" show-overflow-tooltip label="templateId">
            </el-table-column>
            ...
            <el-table-column prop="data" header-align="center" align="center" show-overflow-tooltip label="内容">
            </el-table-column>
...
<script>
import AddOrUpdate from './msgtemplate-add-or-update'
export default {
    data() {
        return {
            dataForm: {
