<template>
    <div class="mod-config">
        ...
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
            ...
            <el-table-column prop="logId" header-align="center" align="center" label="ID">
            </el-table-column>
            <el-table-column prop="touser" header-align="center" align="center" label="openid">
            </el-table-column>
            <el-table-column prop="templateId" header-align="center" align="center" show-overflow-tooltip label="模板ID">
            </el-table-column>
